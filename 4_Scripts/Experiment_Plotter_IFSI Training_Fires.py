...
for experiment in experiment_info.index:
	...
	for chart in channel_groups.groups:
		...
		if chart in skip_charts:
			...
			#Add Grey Data box over bad data where needed.
			if chart in ['Gas_B','Carbon_Monoxide_B']:
				...
				if experiment == 5:
					print ('adding patch')
					p.patch([Start_Time, Start_Time, Start_Time+timedelta(minutes=10, seconds=28), Start_Time+timedelta(minutes=10, seconds=28)], 
						[charts_data['Y_Min'][chart], charts_data['Y_Max'][chart],  charts_data['Y_Max'][chart], charts_data['Y_Min'][chart]], color="grey", alpha=0.5, line_width=1)	
				if experiment == 12:
					print ('adding patch')
					p.patch([Start_Time, Start_Time, Start_Time+timedelta(minutes=4, seconds=24), Start_Time+timedelta(minutes=4, seconds=24)], 
						[charts_data['Y_Min'][chart], charts_data['Y_Max'][chart],  charts_data['Y_Max'][chart], charts_data['Y_Min'][chart]], color="grey", alpha=0.5, line_width=1)	
				if experiment == 14:
					print ('adding patch')
					p.patch([Start_Time, Start_Time, Start_Time+timedelta(minutes=10, seconds=51), Start_Time+timedelta(minutes=10, seconds=51)], 
						[charts_data['Y_Min'][chart], charts_data['Y_Max'][chart],  charts_data['Y_Max'][chart], charts_data['Y_Min'][chart]], color="grey", alpha=0.5, line_width=1)	
				if experiment == 16:
					print ('adding patch')
					p.patch([Start_Time, Start_Time, Start_Time+timedelta(minutes=10, seconds=8), Start_Time+timedelta(minutes=10, seconds=8)], 
						[charts_data['Y_Min'][chart], charts_data['Y_Max'][chart],  charts_data['Y_Max'][chart], charts_data['Y_Min'][chart]], color="grey", alpha=0.5, line_width=1)	
			if chart in ['Heat_Flux_C']:
				if experiment == 17:
					print ('adding patch')
					p.patch([Start_Time, Start_Time, Start_Time+timedelta(minutes=4, seconds=38), Start_Time+timedelta(minutes=4, seconds=33)], 
						[charts_data['Y_Min'][chart], charts_data['Y_Max'][chart],  charts_data['Y_Max'][chart], charts_data['Y_Min'][chart]], color="grey", alpha=0.5, line_width=1)	
			if chart in ['12TC']:
				if experiment == 17:
					print ('adding patch')
